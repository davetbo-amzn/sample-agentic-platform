# FOR NOW THIS CONTENT IS COPIED FROM THE CognitoTokenAuthConverter because
# Bedrock Agentcore is using Cognito by default. We will have to either extend
# this to cover other providers or leave this functionality to the provider.
...
class BedrocKAgentcoreTokenAuthConverter(TokenAuthConverter):
